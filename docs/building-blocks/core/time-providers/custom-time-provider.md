...
public class Program
{
    ...
    {
        var timeProvider = Bedrock.BuildingBlocks.Core.TimeProviders.CustomTimeProvider.DefaultInstance;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        var timeProvider = new Bedrock.BuildingBlocks.Core.TimeProviders.CustomTimeProvider(
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        services.AddSingleton<TimeProvider>(
            _ => new Bedrock.BuildingBlocks.Core.TimeProviders.CustomTimeProvider(
                utcNowFunc: null,
                localTimeZone: null
            )
        );
