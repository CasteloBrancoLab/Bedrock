...
| Característica | `Guid.NewGuid()` (v4) | `Guid.CreateVersion7()` (.NET 9) | `Id.GenerateNewId()` (Bedrock) |
|----------------|----------------------|----------------------------------|-----------------------------------|
...
### Documentação Relacionada no Bedrock
...
- **[Bedrock.BuildingBlocks.Core.Ids.Id Source Code](../../../../src/BuildingBlocks/Core/Ids/Id.cs)**
