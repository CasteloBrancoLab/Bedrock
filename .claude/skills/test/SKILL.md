---
name: test
description: "Fase 3: Testes unitarios. Roda test, corrige falhas e cobre gaps de cobertura."
...
- Rodar `./scripts/test.sh` (ou com argumento de projeto)
...
2. Delegar a haiku: rodar `./scripts/test.sh` e ler pendings
