...
public class BootstrapperTests : TestBase
{
    ...
    [Fact]
    public void ConfigureServices_ShouldRegisterAuthConfigurationManager()
    {
        // Arrange
        ...
        // Assert
        LogAssert("Verificando que AuthConfigurationManager esta registrado como singleton");
        var descriptor = services.SingleOrDefault(d =>
            d.ServiceType == typeof(AuthConfigurationManager));
    ...
    public void ConfigureServices_CalledTwice_ShouldNotDuplicateRegistrations()
    {
        ...
        // Assert
        LogAssert("Verificando que nao duplicou registros (TryAddSingleton)");
        services.Count(d => d.ServiceType == typeof(AuthConfigurationManager)).ShouldBe(1);
    }
}
