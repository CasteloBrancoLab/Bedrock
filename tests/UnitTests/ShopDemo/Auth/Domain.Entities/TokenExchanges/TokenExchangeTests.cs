...
public class TokenExchangeTests : TestBase
{
    ...
    public void IsValid_Static_WithValidInput_ShouldReturnTrue()
    {
        ...
        bool result = TokenExchange.IsValid(executionContext, entityInfo, userId,
            "subject-jti-abc123", "https://api.example.com", "issued-jti-def456",
            DateTimeOffset.UtcNow, DateTimeOffset.UtcNow.AddHours(1));
    ...
    public void IsValid_Instance_WithValidEntity_ShouldReturnTrue()
    {
        ...
        var input = new RegisterNewTokenExchangeInput(
            ...
            "subject-jti-abc123", "https://api.example.com",
            "issued-jti-def456", DateTimeOffset.UtcNow.AddHours(1));
        var entity = TokenExchange.RegisterNew(executionContext, input)!;
