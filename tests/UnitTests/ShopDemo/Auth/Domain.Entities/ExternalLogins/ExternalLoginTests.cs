...
public class ExternalLoginTests : TestBase
{
    ...
    public void IsValid_Static_WithValidInput_ShouldReturnTrue()
    {
        ...
        bool result = ExternalLogin.IsValid(executionContext, entityInfo, userId, LoginProvider.Google, "google-user-123");
    ...
    public void IsValid_Instance_WithValidEntity_ShouldReturnTrue()
    {
        ...
        var executionContext = CreateTestExecutionContext();
        var input = new RegisterNewExternalLoginInput(
            Id.CreateFromExistingInfo(Guid.NewGuid()), LoginProvider.Google, "google-user-123", "user@gmail.com");
        var entity = ExternalLogin.RegisterNew(executionContext, input)!;
