...
public class UserRoleFactoryTests : TestBase
{
    private static readonly Faker Faker = new();

    public UserRoleFactoryTests(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    }
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel with specific userId");
        var expectedUserId = Guid.NewGuid();
        var dataModel = CreateTestDataModel();
        dataModel.UserId = expectedUserId;

        // Act
        LogAct("Creating UserRole from UserRoleDataModel");
        var entity = UserRoleFactory.Create(dataModel);
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel with specific roleId");
        var expectedRoleId = Guid.NewGuid();
        var dataModel = CreateTestDataModel();
        dataModel.RoleId = expectedRoleId;
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel with specific base fields");
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel with null last-changed fields");
        var dataModel = new UserRoleDataModel
        {
            Id = Guid.NewGuid(),
        ...
        // Act
        LogAct("Creating UserRole from UserRoleDataModel with nulls");
        var entity = UserRoleFactory.Create(dataModel);
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel to verify createdCorrelationId is mapped from data model");
        var dataModel = CreateTestDataModel();
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel to verify createdExecutionOrigin is mapped from data model");
        var dataModel = CreateTestDataModel();
    ...
    {
        // Arrange
        LogArrange("Creating UserRoleDataModel to verify createdBusinessOperationCode is mapped from data model");
        var dataModel = CreateTestDataModel();
    ...
    private static UserRoleDataModel CreateTestDataModel()
    {
        return new UserRoleDataModel
        {
            ...
            CreatedBusinessOperationCode = "CREATE_USER_ROLE",
            LastChangedBy = null,
            LastChangedAt = null,
            LastChangedExecutionOrigin = null,
            LastChangedCorrelationId = null,
