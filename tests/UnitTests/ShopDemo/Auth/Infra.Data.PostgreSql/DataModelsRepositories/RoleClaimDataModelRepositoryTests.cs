...
public class RoleClaimDataModelRepositoryTests : TestBase
{
    public RoleClaimDataModelRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper) { }

    [Fact]
    public void Constructor_WithValidDependencies_ShouldCreateInstance()
    {
        LogArrange("Creating mock dependencies");
        var loggerMock = new Mock<ILogger<RoleClaimDataModelRepository>>();
        var unitOfWorkMock = new Mock<IAuthPostgreSqlUnitOfWork>();
        var mapperMock = new Mock<IDataModelMapper<RoleClaimDataModel>>();
        LogAct("Instantiating repository");
        var repository = new RoleClaimDataModelRepository(loggerMock.Object, unitOfWorkMock.Object, mapperMock.Object);
    ...
    public void Constructor_ShouldInheritFromDataModelRepositoryBase()
    {
        ...
        repository.ShouldBeAssignableTo<DataModelRepositoryBase<RoleClaimDataModel>>();
    }
}
