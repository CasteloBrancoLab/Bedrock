...
public class LoginAttemptDataModelRepositoryTests : TestBase
{
    public LoginAttemptDataModelRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper) { }

    [Fact]
    public void Constructor_WithValidDependencies_ShouldCreateInstance()
    {
        LogArrange("Creating mock dependencies");
        var loggerMock = new Mock<ILogger<LoginAttemptDataModelRepository>>();
        var unitOfWorkMock = new Mock<IAuthPostgreSqlUnitOfWork>();
        var mapperMock = new Mock<IDataModelMapper<LoginAttemptDataModel>>();
        LogAct("Instantiating repository");
        var repository = new LoginAttemptDataModelRepository(loggerMock.Object, unitOfWorkMock.Object, mapperMock.Object);
    ...
    public void Constructor_ShouldInheritFromDataModelRepositoryBase()
    {
        ...
        repository.ShouldBeAssignableTo<DataModelRepositoryBase<LoginAttemptDataModel>>();
    }
}
