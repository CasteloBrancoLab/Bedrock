...
public class PasswordResetTokenDataModelRepositoryTests : TestBase
{
    public PasswordResetTokenDataModelRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper) { }

    [Fact]
    public void Constructor_WithValidDependencies_ShouldCreateInstance()
    {
        LogArrange("Creating mock dependencies");
        var loggerMock = new Mock<ILogger<PasswordResetTokenDataModelRepository>>();
        var unitOfWorkMock = new Mock<IAuthPostgreSqlUnitOfWork>();
        var mapperMock = new Mock<IDataModelMapper<PasswordResetTokenDataModel>>();
        LogAct("Instantiating repository");
        var repository = new PasswordResetTokenDataModelRepository(loggerMock.Object, unitOfWorkMock.Object, mapperMock.Object);
    ...
    public void Constructor_ShouldInheritFromDataModelRepositoryBase()
    {
        ...
        repository.ShouldBeAssignableTo<DataModelRepositoryBase<PasswordResetTokenDataModel>>();
    }
}
