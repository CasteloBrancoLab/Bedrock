...
public class RoleHierarchyDataModelRepositoryTests : TestBase
{
    public RoleHierarchyDataModelRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper) { }

    [Fact]
    public void Constructor_WithValidDependencies_ShouldCreateInstance()
    {
        LogArrange("Creating mock dependencies");
        var loggerMock = new Mock<ILogger<RoleHierarchyDataModelRepository>>();
        var unitOfWorkMock = new Mock<IAuthPostgreSqlUnitOfWork>();
        var mapperMock = new Mock<IDataModelMapper<RoleHierarchyDataModel>>();
        LogAct("Instantiating repository");
        var repository = new RoleHierarchyDataModelRepository(loggerMock.Object, unitOfWorkMock.Object, mapperMock.Object);
    ...
    public void Constructor_ShouldInheritFromDataModelRepositoryBase()
    {
        ...
        repository.ShouldBeAssignableTo<DataModelRepositoryBase<RoleHierarchyDataModel>>();
    }
}
