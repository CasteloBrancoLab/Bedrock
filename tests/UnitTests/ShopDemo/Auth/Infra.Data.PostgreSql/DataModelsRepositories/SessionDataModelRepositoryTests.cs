...
public class SessionDataModelRepositoryTests : TestBase
{
    public SessionDataModelRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper) { }

    [Fact]
    public void Constructor_WithValidDependencies_ShouldCreateInstance()
    {
        LogArrange("Creating mock dependencies");
        var loggerMock = new Mock<ILogger<SessionDataModelRepository>>();
        var unitOfWorkMock = new Mock<IAuthPostgreSqlUnitOfWork>();
        var mapperMock = new Mock<IDataModelMapper<SessionDataModel>>();
        LogAct("Instantiating repository");
        var repository = new SessionDataModelRepository(loggerMock.Object, unitOfWorkMock.Object, mapperMock.Object);
    ...
    public void Constructor_ShouldInheritFromDataModelRepositoryBase()
    {
        ...
        repository.ShouldBeAssignableTo<DataModelRepositoryBase<SessionDataModel>>();
    }
}
