...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Serialization.Protobuf.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Serialization.Protobuf", "Bedrock.BuildingBlocks.Serialization.Protobuf.csproj")];
    }
}
