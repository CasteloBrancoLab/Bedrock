using Bedrock.ArchitectureTests.BuildingBlocks.Serialization.Protobuf.Fixtures;
using Bedrock.BuildingBlocks.Testing.Architecture.Tests;
using Xunit;
using Xunit.Abstractions;

namespace Bedrock.ArchitectureTests.BuildingBlocks.Serialization.Protobuf;
