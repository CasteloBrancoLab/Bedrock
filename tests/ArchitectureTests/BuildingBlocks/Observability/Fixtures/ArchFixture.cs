...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Observability.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Observability", "Bedrock.BuildingBlocks.Observability.csproj")];
    }
}
