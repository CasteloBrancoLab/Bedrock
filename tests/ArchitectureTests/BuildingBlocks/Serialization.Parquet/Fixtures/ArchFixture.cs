...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Serialization.Parquet.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Serialization.Parquet", "Bedrock.BuildingBlocks.Serialization.Parquet.csproj")];
    }
}
