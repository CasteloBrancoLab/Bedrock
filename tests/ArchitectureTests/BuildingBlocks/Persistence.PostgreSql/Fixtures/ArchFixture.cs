...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Persistence.PostgreSql.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Persistence.PostgreSql", "Bedrock.BuildingBlocks.Persistence.PostgreSql.csproj")];
    }
}
