...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Data.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Data", "Bedrock.BuildingBlocks.Data.csproj")];
    }
}
