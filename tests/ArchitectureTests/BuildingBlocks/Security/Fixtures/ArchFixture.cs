...
namespace Bedrock.ArchitectureTests.BuildingBlocks.Security.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "BuildingBlocks", "Security", "Bedrock.BuildingBlocks.Security.csproj")];
    }
}
