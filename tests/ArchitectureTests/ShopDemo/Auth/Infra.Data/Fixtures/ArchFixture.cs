...
namespace Bedrock.ArchitectureTests.ShopDemo.Auth.Infra.Data.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "ShopDemo", "Auth", "Infra.Data", "ShopDemo.Auth.Infra.Data.csproj")];
    }
}
