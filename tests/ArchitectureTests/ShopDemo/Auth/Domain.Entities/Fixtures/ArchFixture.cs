...
namespace Bedrock.ArchitectureTests.ShopDemo.Auth.Domain.Entities.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "ShopDemo", "Auth", "Domain.Entities", "ShopDemo.Auth.Domain.Entities.csproj")];
    }
}
