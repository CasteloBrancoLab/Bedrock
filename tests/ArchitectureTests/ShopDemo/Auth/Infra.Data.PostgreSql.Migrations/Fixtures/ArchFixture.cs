...
namespace Bedrock.ArchitectureTests.ShopDemo.Auth.Infra.Data.PostgreSql.Migrations.Fixtures;
...
public sealed class ArchFixture : RuleFixture
{
    ...
    {
        return [Path.Combine(rootDir, "src", "ShopDemo", "Auth", "Infra.Data.PostgreSql.Migrations", "ShopDemo.Auth.Infra.Data.PostgreSql.Migrations.csproj")];
    }
}
