...
/// <summary>
/// Fixture que carrega a compilacao do projeto Templates.Domain.Entities para analise arquitetural.
/// </summary>
public sealed class ArchFixture : RuleFixture
{
    protected override IReadOnlyList<string> GetProjectPaths(string rootDir)
    {
        return [Path.Combine(rootDir, "src", "Templates", "Domain.Entities", "Templates.Domain.Entities.csproj")];
    }
}
