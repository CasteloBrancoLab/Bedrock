...
public sealed class DomainEntitiesRuleTests : RuleTestBase<DomainEntitiesArchFixture>
{
    public DomainEntitiesRuleTests(DomainEntitiesArchFixture fixture, ITestOutputHelper output)
        : base(fixture, output) { }
