...
using ShopDemo.IntegrationTests.Auth.Infra.Data.Connections;

namespace ShopDemo.IntegrationTests.Auth.Infra.Data.Fixtures;

/// <summary>
/// Fixture for Auth Infra.Data integration tests.
/// Tests the facade layer (UserRepository) that bridges Domain interfaces to PostgreSQL.
/// </summary>
public class AuthDataFixture : ServiceCollectionFixture
{
    public string GetAdminConnectionString()
    {
        return Environments["auth-data"]
            .Postgres["main"]
    ...
    protected override void ConfigureEnvironments(IEnvironmentRegistry environments)
    {
        ...
        environments.Register("auth-data", env => env
