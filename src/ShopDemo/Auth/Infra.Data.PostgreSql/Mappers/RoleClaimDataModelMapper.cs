...
public sealed class RoleClaimDataModelMapper
    : DataModelMapperBase<RoleClaimDataModel>
{
    protected override void ConfigureInternal(MapperOptions<RoleClaimDataModel> mapperOptions)
    {
        mapperOptions
            .MapTable(schema: "public", name: "auth_role_claims")
            .MapColumn(static x => x.RoleId)
    ...
    public override void MapBinaryImporter(NpgsqlBinaryImporter importer, RoleClaimDataModel model)
    {
        ...
        importer.Write(model.RoleId, NpgsqlDbType.Uuid);
