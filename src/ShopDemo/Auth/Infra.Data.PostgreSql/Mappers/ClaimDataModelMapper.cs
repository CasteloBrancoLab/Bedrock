...
public sealed class ClaimDataModelMapper
    : DataModelMapperBase<ClaimDataModel>
{
    protected override void ConfigureInternal(MapperOptions<ClaimDataModel> mapperOptions)
    {
        mapperOptions
            .MapTable(schema: "public", name: "auth_claims")
    ...
    public override void MapBinaryImporter(NpgsqlBinaryImporter importer, ClaimDataModel model)
    {
