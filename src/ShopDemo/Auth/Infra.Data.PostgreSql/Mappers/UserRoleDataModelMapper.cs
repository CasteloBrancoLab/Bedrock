...
public sealed class UserRoleDataModelMapper
    : DataModelMapperBase<UserRoleDataModel>
{
    protected override void ConfigureInternal(MapperOptions<UserRoleDataModel> mapperOptions)
    {
        mapperOptions
            .MapTable(schema: "public", name: "auth_user_roles")
    ...
    public override void MapBinaryImporter(NpgsqlBinaryImporter importer, UserRoleDataModel model)
    {
