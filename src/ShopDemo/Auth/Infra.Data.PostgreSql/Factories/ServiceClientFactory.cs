...
{
    public static ServiceClient Create(ServiceClientDataModel dataModel)
    {
        ...
        return ServiceClient.CreateFromExistingInfo(
            new CreateFromExistingInfoServiceClientInput(
                entityInfo,
                dataModel.ClientId,
                dataModel.ClientSecretHash,
                dataModel.Name,
                (ServiceClientStatus)dataModel.Status,
                Id.CreateFromExistingInfo(dataModel.CreatedByUserId),
                dataModel.ExpiresAt,
                dataModel.RevokedAt));
    }
}
