...
public static class ClaimDependencyFactory
{
    public static ClaimDependency Create(ClaimDependencyDataModel dataModel)
    {
        ...
        return ClaimDependency.CreateFromExistingInfo(
            new CreateFromExistingInfoClaimDependencyInput(
                ...
                Id.CreateFromExistingInfo(dataModel.DependsOnClaimId)));
    }
}
