...
public static class RoleHierarchyFactory
{
    public static RoleHierarchy Create(RoleHierarchyDataModel dataModel)
    {
        ...
        return RoleHierarchy.CreateFromExistingInfo(
            new CreateFromExistingInfoRoleHierarchyInput(
                entityInfo,
                Id.CreateFromExistingInfo(dataModel.RoleId),
                Id.CreateFromExistingInfo(dataModel.ParentRoleId)));
    }
}
