...
public static class DataModelBaseFactory
{
        ...
        where TEntity : IEntity
    {
        TDataModel dataModel = new()
        {
            ...
            CreatedCorrelationId = entity.EntityInfo.EntityChangeInfo.CreatedCorrelationId,
            CreatedExecutionOrigin = entity.EntityInfo.EntityChangeInfo.CreatedExecutionOrigin,
            CreatedBusinessOperationCode = entity.EntityInfo.EntityChangeInfo.CreatedBusinessOperationCode,
