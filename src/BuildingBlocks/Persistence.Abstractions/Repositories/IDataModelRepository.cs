    ...
    where TDataModel : class
{
    ...
    Task<TDataModel?> GetByIdAsync(ExecutionContext executionContext, Guid id, CancellationToken cancellationToken);
    ...
    /// Errors are added to the ExecutionContext for later inspection.
    /// </remarks>
    ...
    Task<bool> ExistsAsync(ExecutionContext executionContext, Guid id, CancellationToken cancellationToken);
